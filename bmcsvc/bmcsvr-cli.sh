...
# Usage: bmcsvr-cli.sh discovery <CIDR> [CIDR...] [--timeout 1] [--parallel 50]
#                                [--cache] [--table] [--json]
# =============================================================================
...
main() {
    ...
    case "$1" in
        ...
        version)    echo "bmcsvr-cli.sh v${VERSION}" ;;
        help|--help|-h) usage ;;
